...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="/Public/Admin/Css/zcomm.css"/>
...
<div class="main-container" id="main-container">
    ...
    <?php if(is_array($Config["menu"])): foreach($Config["menu"] as $key=>$menu): if(isset($menu["control_sub"])): ?><li class="<?php echo ($menu["control_status"]); ?>">
                ...
                <ul class="submenu">
                    <?php if(is_array($menu["control_sub"])): foreach($menu["control_sub"] as $key=>$sub): ?><li class="<?php echo ($sub["sub_status"]); ?>">
                            <a href="<?php echo U($sub['sub_link']);?>">
        ...
        <?php else: ?>
            <li class="<?php echo ($menu["control_status"]); ?>">
                <a href="<?php echo U($menu['control_link']);?>">
    ...
    <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
        <table class="table table-striped table-bordered table-hover dataTable center">
            ...
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                    ...
                    <td><?php echo ($vo["rolerank"]); ?></td>
                    <td><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>
                    <td>
                        <button class="btn btn-xs btn-info">
                            <i class="icon-edit bigger-120"></i>
                        </button>
                        <button class="btn btn-xs btn-danger" value="<?php echo ($vo["userid"]); ?>" onclick='deleteUser(this)'>
        ...
        <div class="row">
            <!--<div class="col-sm-6">-->
                <!--<div id="sample-table-2_info" class="dataTables_info">显示第 1 到第 10 条记录,总共 23 条记录</div>-->
            <!--</div>-->
            <!--<div class="col-sm-6">-->
...
<script>
    function deleteUser(e) {
        location.href = "/index.php/Admin/User/delete?userId="+e.value;
    }
</script></div>
