...
<div class="main-container" id="main-container">
    ...
    <?php if(is_array($Config["menu"])): foreach($Config["menu"] as $key=>$menu): if(isset($menu["control_sub"])): ?><li class="<?php echo ($menu["control_status"]); ?>">
        ...
        <div class="main-content">
            ...
            <div class="page-content"><!--CREATE TABLE sys_user(-->
...
<div >
    <form action="/index.php/Admin/User/adduser" method="post" role="form" class="form-horizontal" >
        ...
        <div class="form-group">
            ...
            <div class="col-xs-10">
                <input type="text" class="form-control" name="roleRank" id="raleRank"/>
            </div>
        </div>
        <div class="form-group">
